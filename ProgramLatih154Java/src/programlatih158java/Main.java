/*
 * Program Mengedit Rekord Tabel
 */

package programlatih158java;
import java.sql.*;
/**
 *
 * @author epurwanto
...
public static void main(String[] args) {
 ResultSet rslt; 
        ...
        try {
            ...
            System.out.println("DATA-DATA ABSEN SEBELUM DI EDIT       ");
            System.out.println("--------------------------------------------------");
            JmlRekord=0;
            // Mencetak Rekord
            ...
            qry="Update absen Set Nip='000000001' Where nokartu='K000001'";
            st.executeUpdate(qry);
            //Menampilkan Rekord Setelah di Update
            qry = "SELECT * from absen";
            rslt=st.executeQuery(qry);
             System.out.println("DATA-DATA ABSEN SETELAH DI EDIT       ");
            System.out.println("--------------------------------------------------");
            JmlRekord=0;
            // Mencetak Rekord
            System.out.println("No Kartu         Nip              Warna");
